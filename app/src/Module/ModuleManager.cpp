...
{
  // Init translator
  // (void)Translator::instance();

  printf("run module manager start\n");

  // Stop modules when application is about to quit
  // connect(&m_engine, &QQmlApplicationEngine::quit, this, &ModuleManager::onQuit);

  printf("run module manager end\n");
}

/**
 * Returns a pointer to the QML application engine
 */
const QQmlApplicationEngine &ModuleManager::engine() const
{
  return m_engine;
}
 ...
 * for installing it.
 */
bool ModuleManager::autoUpdaterEnabled() const
{
#ifdef DISABLE_QSU
  return false;
#else
...
// {
//   // TimerEvents::instance().stopTimers();
...
//   // auto miscUtilities = &Utilities::instance();
//   // auto ioNetwork = &IO::Drivers::Network::instance();
//   // auto frameBuilder = &JSON::FrameBuilder::instance();
//   // auto miscTranslator = &Translator::instance();
//   // auto projectModel = &JSON::ProjectModel::instance();
//   // auto miscTimerEvents = &TimerEvents::instance();
//   // auto miscCommonFonts = &CommonFonts::instance();
//   // auto miscThemeManager = &ThemeManager::instance();
...
//   // connect(miscTranslator, &Translator::languageChanged, &m_engine,
