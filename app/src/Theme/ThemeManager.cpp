 ...
 * @return The index of the currently active theme.
 */
const QString &ThemeManager::themeName() const
{
  return m_themeName;
}
 ...
 */
const QJsonObject &ThemeManager::colors() const
{
  return m_colors;
}
 ...
 */
const QJsonObject &ThemeManager::themeData() const
{
  return m_themeData;
}
 ...
 */
const QStringList &ThemeManager::availableThemes() const
{
 ...
 */
void ThemeManager::setTheme(const int index)
{
  // Validate index
